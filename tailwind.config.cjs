...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        railPulse: {
          "0%": { transform: "translateY(-60px)", opacity: "0.9" },
          "50%": { transform: "translateY(700px)", opacity: "1" },
          "100%": { transform: "translateY(-60px)", opacity: "0.9" },
        },
      },
      animation: {
        railPulse: "railPulse 10s ease-in-out infinite",
      },
    },
  },
