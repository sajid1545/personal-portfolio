...
const IMG_URL = "/public/sajjad.png";
...
const PROJECTS = [
	...
	},
	{
		...
		tech: ["React.js", "Tailwind CSS", "Express.js", "MongoDB", "Firebase", "Stripe", "JWT"],
	...
	},
	{
		...
		tech: ["React.js", "Tailwind CSS", "Express.js", "MongoDB", "Firebase", "JWT"],
				...
				<div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-10 items-center">
					...
					<div className="md:col-span-7">
						...
						<motion.p {...fadeUp(0.08)} className="mt-5 text-white/75 max-w-2xl">
							At <b>Zentexx</b> and previously at <b>Ekopii</b>, I’ve shipped responsive interfaces,
							engineered secure APIs, and delivered features end-to-end. React & Tailwind on the
							front, Node/Express with MongoDB or Postgres/Prisma on the back — pragmatic, fast, and
							clean.
						</motion.p>
