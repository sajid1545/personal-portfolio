		...
		<div id='about' className="my-10 h-screen">
			...
			<div  className="flex justify-center flex-col-reverse lg:flex-row  items-center w-[95%] gap-10 mx-auto">
				<div  className="my-info w-full lg:w-[75%] text-center lg:text-left">
						<p  data-aos="fade-left" className="text-3xl mb-10">
							...
							currently pursuing BSc. in Information Technology. I am a passionate Web Developer who loves building Web applications with JavaScript, React.js, express.js and some other cool libraries and frameworks
						</p>
				</div>

					<div data-aos="fade-right" className="my-pic w-[80%] lg:w-2/4">
